...
terraform {
  ...
  required_providers {
    oci = {
      source  = "oracle/oci"
      version = ">= 4.118.0"
      # https://registry.terraform.io/providers/hashicorp/oci/4.118.0
    }
    kubernetes = {
    ...
    tls = {
      ...
      version = "4.0.4" # Latest version as January 2022 = 3.1.0.
      # https://registry.terraform.io/providers/hashicorp/tls/3.1.0
    }
    local = {
      source  = "hashicorp/local"
      version = "2.3.0" # Latest version as January 2022 = 2.1.0.
      # https://registry.terraform.io/providers/hashicorp/local/2.1.0
    }
    random = {
      source  = "hashicorp/random"
      version = "3.4.3" # Latest version as January 2022 = 3.1.0.
